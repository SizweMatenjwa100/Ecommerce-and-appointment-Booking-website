...
{
    public partial class RTest : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                SqlDataAdapter da = new SqlDataAdapter("select * from tblEmployee2", con);

                DataTable dt = new DataTable();
                da.Fill(dt);

                DropDownList1.DataSource = dt;
                DropDownList1.DataTextField = "Employee_FName";
                DropDownList1.DataValueField = "Employee_ID";
                DropDownList1.DataBind();

                ListItem liFirst = new ListItem("Select a Barber", "-1");
                DropDownList1.Items.Insert(0, liFirst);

                RandomBarber();

                if (DDsp.SelectedValue == "-1")
                {
        ...
        private void RandomBarber()
        {
            string[] tbl = new string[5];

            tbl[0] = "Nikita (Massues)"; tbl[1] = "Snegugu (Hair Stylist)"; tbl[2] = "Makhelwane (Barber)"; tbl[3] = "Sphiwe (Nail Grapher)"; 
        ...
        protected void btnCheckAvailability_Click(object sender, EventArgs e)
        {
            ...
            if (sdate != null && !DropDownList1.SelectedValue.ToString().Equals("-1"))
            {
                if (ddlTimeIn.SelectedValue.ToString().Equals("-1") || (ddlTimeOut.SelectedValue.ToString().Equals("-1")))
                {
                    ...
                    lblDate.Text = sdate + " : ";
                    lblBarber.Text = DropDownList1.SelectedItem.ToString();
                ...
                else
                {
                    ...
                    da.SelectCommand.Parameters.AddWithValue("@EmplName", DropDownList1.SelectedItem.ToString());
                    ...
                    {
                        lblMessage.BackColor = System.Drawing.ColorTranslator.FromHtml("#4dff4d");
                        lblMessage.Text = "Time is available for the selected time <br/> You can go ahead and make your reservation";
                        lblDate.Text = sdate + " : ";
                        lblBarber.Text = DropDownList1.SelectedItem.ToString();
                    }
            ...
            else
            {
                ...
                lblBarber.Text = "";
                lblMessage.BackColor = System.Drawing.ColorTranslator.FromHtml("#4dff4d");
                lblMessage.Text = "Please select the service and the date";
            }

        }

        private void DisplayAvailableTimeForChasenTable(string Empl, string sdate)
        {
            SqlConnection con = new SqlConnection(CS);
            ...
            da.SelectCommand.Parameters.AddWithValue("@EmplName", Empl);
        ...
        protected void SubmitReservation_Click(object sender, EventArgs e)
        {
            ...
            {
                Uid = Convert.ToInt32(Session["Customer_ID"]);
                ...
                if (Calendar1.SelectedDate.ToString("yyyy-MM-dd") != "0001-01-01" && Calendar1.SelectedDate != null && ddlTimeIn.SelectedValue.ToString() != "-1" && ddlTimeOut.SelectedValue.ToString() != "-1" && DropDownList1.SelectedValue.ToString() != "-1")
                {
                    ...
                    {
                        lblMessage.BackColor = System.Drawing.ColorTranslator.FromHtml("#ff4d4d");
                        lblMessage.Text = "The selected Reservation is not available at the moment <br/> Please view the following list for available times";
                        lblDate.Text = sdate + " : ";
                        lblBarber.Text = DropDownList1.SelectedItem.ToString();
                    ...
                    else
                    {
                        using (con)
                        {
                            ...
                            cmd.Parameters.AddWithValue("@REmplName", DropDownList1.SelectedItem.ToString());
                            cmd.Parameters.AddWithValue("@RUid", Uid);
                            cmd.Parameters.AddWithValue("@sp", DDsp.SelectedItem.ToString());
                        ...
                        lblMessage.BackColor = System.Drawing.ColorTranslator.FromHtml("#4dff4d");
                        lblMessage.Text = "Congratulations your reservation has been made successfull. <br/> We are looking forward to having you in our salon";
        ...
        protected void DDsp_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (DDsp.SelectedValue == "-1")
            {
                DropDownList1.Enabled = false;
        ...
        protected void ddlTimeIn_SelectedIndexChanged1(object sender, EventArgs e)
        {
            ddlTimeOut.Items.Clear();
            String hr = "";

            switch (ddlTimeIn.SelectedItem.ToString())
            {
                case ("7:00 am"):
                    hr = "8:00 am";
                    break;
            ...
            ListItem Li = new ListItem(hr ,"0");
            ddlTimeOut.Items.Add(Li);
        }
    }
}